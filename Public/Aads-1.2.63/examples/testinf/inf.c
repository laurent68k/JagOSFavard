...

{
	...
	if((FichierINF = fopen(INIFILENAME, "w")) != NULL)
	{
...
long GetLongProfile(char *FileNameINF, char *Chapitre, char *Entree, long Default)
{
	...
	char	ValueDefault[128];

	ltoa(Default, ValueDefault, 10);
	GetProfileString(FileNameINF, Chapitre, Entree, ValueString, ValueDefault);
