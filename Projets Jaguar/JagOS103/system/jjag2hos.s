...
; ---------------------------------------------------------------------------
;		void cdecl JJag2Host(long TargetPID, void *Address, unsigned long Lenght)
;
;		This function is called when the JAGUAR want to send a memory block
;		 to the Atari
;
;	FONCTION:	Number 1
;
...
JJag2Host:				sub.l		#SIZE_JAGMEMDESC,sp 							;	reserve a location for a TJagMemDesc
						move.l		sp,a0
