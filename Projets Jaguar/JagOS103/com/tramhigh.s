...
N_REGS_GT				set			5												;	number of reg. saved
...
GetFrame:				movem.l		d1-d2/a0-a2,-(sp)
						...
						movea.l		_CurrRead,a2									;	store the current GetPack()
...
; ---------------------------------------------------------------------------
;
;	d0	=	return value, always modified
;	d1	=
;	a0	=	
;	a2	=	Current SendPack()'driver

N_REGS_ST				set			4										;	number of reg. saved
...
SendFrame:				movem.l		d1/a0-a2,-(sp)
						movea.l		_CurrWrite,a2
...
.EndNoError:			movem.l		(sp)+,d1/a0-a2
						move.l		#TRUE,d0
						rts

.EndWithError:			movem.l		(sp)+,d1/a0-a2
						move.l		#FALSE,d0
						rts
