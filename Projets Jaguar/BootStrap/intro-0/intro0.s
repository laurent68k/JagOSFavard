...
StartBoot:					move.w      #$1879,MEMCON1				; RAM wait state, ROM n clock cycles	
							...
							move.l      #$FF,BORD1					; border color (green,red,unused,blue)
...
PAL:	    				move.w      (A0)+,CLK2					; Jerry
							...
							move.w      (a0),VDE		
					;		move.w		#$ffff,VDE  	 			; due to a bug in Jaguar Console !
							move.w		(a0)+,VarVde
...
;	Computer (64x64)
							...
							dc.l	DISPBUF3
							dc.l	ComputerOkROM
							dc.w	ComputerOkCountROM-ComputerOkROM
							dc.w	32-1
							dc.w	192+128
...
FujiROM:					include	"flags.cry"
FujiCountROM:				dc.l	$00000000

ComputerOkROM:				include	"colours.cry"
ComputerOkCountROM:			dc.l	$00000000

Message1:					dc.b	"BootRom Version 1.00 FunShip 1997",0
Message2:					dc.b	"Awaiting to upload a program...",0
